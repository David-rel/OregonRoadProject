...
public class OregonRoadMain {
    ...
    public static void ShopItemBought(int choice, int Descison){
        ...
        if(ShopAskA == 0) {
            ...
            ShopAsk2 SAS2 = new ShopAsk2(money, food, miles, days, difficulty);
            ShopAskA++;
        }
...
//                }
    ...
    public static void CheckDay(){
        ...
        while (StartTrail == 2){
            ...
            if(check_days == 9){
                days = days + 1;
                BrokenPart3 BP3 = new BrokenPart3(money, food, miles, days, difficulty);
                System.out.println(ResultCall);
            ...
            if(check_days == 11){
                days = days + 1;
                DiseaseOutbreak3 DO3 = new DiseaseOutbreak3(money, food, miles, days, difficulty);
                System.out.println(ResultCall);
            ...
            if(check_days == 12){
                ...
                SellShop SS = new SellShop(money, food, miles, days, difficulty);
                break;
            }
        }
    }
