package MainTrail.StartTrail.TrailTwo.DayTwo;
...
public class FriendMeetUp extends JFrame implements ActionListener {
    ...
    JLabel CHOICE1 = new JLabel("1. Team Up.");
    JLabel CHOICE2 = new JLabel("2. Say Hello");
    JLabel CHOICE3 = new JLabel("3. Ignore him");
    ...
    public FriendMeetUp(int money, int food, int miles, int days, String difficulty){
...
//------------------------------------------------------------------------
        ...
        PROMPT.setText("Day Two: you find your best friend while traveling. Do you.");
