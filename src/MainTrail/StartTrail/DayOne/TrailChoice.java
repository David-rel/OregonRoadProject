package MainTrail.StartTrail.DayOne;
...
public class TrailChoice extends JFrame implements ActionListener {
        ...
        JLabel CHOICE1 = new JLabel("1. Cross The River");
        JLabel CHOICE2 = new JLabel("2. Find a new trail");
        ...
        public TrailChoice(int money, int food, int miles, int days, String difficulty){
...
//------------------------------------------------------------------------
                ...
                PROMPT.setText("Day One: as you approach the river you notice the bridge is down. Do you.");
        ...
        public void actionPerformed(ActionEvent e) {
                ...
                if(e.getSource() == ENTER_BUTTON){
                        if(ANSWER.getText().equals("1")){
                                choice = 1;
                                TrailChoice = 1;
                                OregonRoadMain.GetResult(choice, TrailChoice);
                                this.dispose();
