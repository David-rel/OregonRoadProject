package MainTrail.StartTrail.TrailOne.DayThree;
...
public class StopPoint extends JFrame implements ActionListener {
    ...
    JLabel CHOICE1 = new JLabel("1. Stop for the day");
    JLabel CHOICE2 = new JLabel("2. Stop for a little");
    ...
    public StopPoint(int money, int food, int miles, int days, String difficulty){
        ...
        this.setTitle("Stop Point Scenery");
...
//------------------------------------------------------------------------
        ...
        PROMPT.setText("Day Three: you are at a stopping point would you like to spend the night and watch the scenary");
