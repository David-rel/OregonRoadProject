package MainTrail.StartTrail.TrailOne.DayTwo;
...
public class StrangerMeetUp extends JFrame implements ActionListener {
    ...
    JLabel CHOICE1 = new JLabel("1. Some pocket change ($2), dropping some coins in his hand.");
    JLabel CHOICE2 = new JLabel("2. A small sun ($10), saying how you need it for the trip");
    JLabel CHOICE3 = new JLabel("3. A large sum ($75), saying he needs it more than you");
    JLabel CHOICE4 = new JLabel("4. Nothing, telling him to stop bothering you");
    ...
    public StrangerMeetUp(int money, int food, int miles, int days, String difficulty){
        ...
        this.setTitle("Stranger Meet Up");
...
//------------------------------------------------------------------------
        ...
        PROMPT.setText("Day Two: you find a stranger who is asking for some spare change. you give it to him");
        ...
        MainGamePanel.add(PLAYER_INFO_BUTTON, Integer.valueOf(2));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == ENTER_BUTTON){
            if(ANSWER.getText().equals("1")){
                choice = 1;
                OregonRoadMain.GetResult(choice, 1);
                this.dispose();
