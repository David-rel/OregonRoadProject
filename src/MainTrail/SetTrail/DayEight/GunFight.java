package MainTrail.SetTrail.DayEight;
...
public class GunFight extends JFrame implements ActionListener {
    ...
    JLabel CHOICE1 = new JLabel("1. fight them");
    JLabel CHOICE2 = new JLabel("2. Hide from them");
    JLabel CHOICE3 = new JLabel("3. Run");
    JLabel CHOICE4 = new JLabel("4. try to make peace");
    ...
    public GunFight(int money, int food, int miles, int days, String difficulty){
...
//------------------------------------------------------------------------
        ...
        if(days == 8){
            PROMPT.setText("Day Eight: while you are walking you see two people try to mug you. do you.");
        }
        else{
            PROMPT.setText("Day Seven: while you are walking you see two people try to mug you. do you.");
        }
