...
public class ShopAsk extends JFrame implements ActionListener {
    ...
    static final Dimension SCREEN_SIZE = new Dimension(GAME_WIDTH, GAME_HEIGHT);
         ...
         public ShopAsk(int money, int food, int miles, int days, String difficulty){
...
//------------------------------------------------------------------------
            ...
            PROMPT.setText("Would you like to " + "go to the SHOP before you start your journey");
